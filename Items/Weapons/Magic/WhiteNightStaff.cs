...
{
	public class WhiteNightStaff : ModItem
	{
        public override string Texture => "SinsMod/Extra/Placeholder/Placeholder";
        public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("Rose at White Night");
        ...
        {
            item.mana = (player.altFunctionUse != 2) ? 20 : 12;
            item.useTime = (player.altFunctionUse != 2) ? 18 : 10;
            item.useAnimation = (player.altFunctionUse != 2) ? 18 : 10;
            item.shoot = (player.altFunctionUse != 2) ? mod.ProjectileType("Thorn") : mod.ProjectileType("WhiteNightBeam");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "PolarNightStaff");
