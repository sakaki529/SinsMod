...
{
    public class NyarlathotepTentacle : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            if (projectile.scale < 1f)
            {
                ...
                {
                    int num2 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, (Main.rand.Next(2) == 0) ? 175 : 109, projectile.velocity.X, projectile.velocity.Y, 100, default(Color), 1.5f);
