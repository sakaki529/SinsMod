...
{
    public class SakuraHeal : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (num5 < 50f && projectile.position.X < Main.player[num].position.X + Main.player[num].width && projectile.position.X + projectile.width > Main.player[num].position.X && projectile.position.Y < Main.player[num].position.Y + Main.player[num].height && projectile.position.Y + (float)projectile.height > Main.player[num].position.Y)
            {
            ...
            for (int num7 = 0; num7 < 4; num7++)
            {
                ...
                int num10 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 73, 0f, 0f, 100, default(Color), 0.7f);
