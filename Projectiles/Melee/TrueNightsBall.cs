...
{
    public class TrueNightsBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < 4; i++)
            {
                int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, (int)projectile.ai[0] == 0 ? 75 : 27, 0f, 0f, 100, default(Color), 0.9f);
