...
{
    public class LustPrism : ModProjectile
    {
            ...
            if (flag10 && Main.myPlayer == projectile.owner)
            {
                ...
                if (flag12)
                {
                    if (projectile.ai[0] == 1f)
                    {
                        ...
                        Projectile.NewProjectile(center3.X, center3.Y, vector12.X, vector12.Y, mod.ProjectileType("LustPrismBeam"),num29, projectile.knockBack, projectile.owner, 0, projectile.whoAmI);
                        projectile.netUpdate = true;
                    }
                }
                else
