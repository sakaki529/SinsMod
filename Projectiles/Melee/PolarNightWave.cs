...
{
    public class PolarNightWave : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Polar Night Wave");
        ...
        public override void AI()
        {
            for (int i = 0; i < 1; i++)
            {
                ...
                Dust dust = Dust.NewDustDirect(projectile.Center, 0, 0, 186, 0f, 0f, 0, default(Color), 0.6f);
                dust.fadeIn = 0.7f;
                dust.velocity *= 0.3f;
        ...
        public override void Kill(int timeleft)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                int num2 = Dust.NewDust(projectile.Center, 0, 0, 186, 0f, 0f, 0, default(Color), 0.8f);
        ...
        {
            return Color.Black * (1f - projectile.alpha / 255f);
        }
    }
}