...
{
    public class TrueMidnightKnives : ModItem
	{
        public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("True Midnight Knives");
            Tooltip.SetDefault("Shoot true midnight knives to all direction");
		}
		public override void SetDefaults()
		{
			...
			item.useStyle = 1;
			item.knockBack = 3;
            item.shoot = mod.ProjectileType("TrueMidnightKnives");
            item.shootSpeed = 15f;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "MidnightKnives");
