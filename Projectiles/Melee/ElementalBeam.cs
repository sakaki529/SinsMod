...
{
    public class ElementalBeam : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if (canSpawnPro)
            {
                float posX = target.Center.X + (target.width / 2 + 100);
                float posX2 = target.Center.X - (target.width / 2 + 100);
                float posY = target.Center.Y + (target.height / 2 + 100);
                float posY2 = target.Center.Y - (target.height / 2 + 100);
                Vector2 vector = target.Center - projectile.Center;
                vector.Normalize();
                Projectile.NewProjectile(posX, posY, -25f, -25f, mod.ProjectileType("ElementalBeamSmall"), projectile.damage, 0f, projectile.owner, (int)projectile.ai[0] == 8 ? Main.rand.Next(9) : 0, 0f);//RU
                Projectile.NewProjectile(posX, posY2, -25f, 25f, mod.ProjectileType("ElementalBeamSmall"), projectile.damage, 0f, projectile.owner, (int)projectile.ai[0] == 8 ? Main.rand.Next(9) : 0, 0f);//RO
                Projectile.NewProjectile(posX2, posY, 25f, -25f, mod.ProjectileType("ElementalBeamSmall"), projectile.damage, 0f, projectile.owner, (int)projectile.ai[0] == 8 ? Main.rand.Next(9) : 0, 0f);//LU
                Projectile.NewProjectile(posX2, posY2, 25f, 25f, mod.ProjectileType("ElementalBeamSmall"), projectile.damage, 0f, projectile.owner, (int)projectile.ai[0] == 8 ? Main.rand.Next(9) : 0, 0f);//LO
            }
            if (canHeal)
            {
