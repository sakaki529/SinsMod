...
{
    public class TrueMidnightLaser : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight((int)projectile.Center.X / 16, (int)projectile.Center.Y / 16, 0.4f, 0.15f, 0.35f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            int num = Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("TrueMidnightExplosion"), projectile.damage / 2, projectile.knockBack, projectile.owner, 0f, 0f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num3 = Dust.NewDust(projectile.Center - projectile.velocity / 2f, 0, 0, 112, 0f, 0f, 100, default(Color), 1.0f);
