...
{
    public class LightningDark : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch sb, Color lightColor)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    DelegateMethods.c_1 = new Color(40, 40, 40, 0) * 0.5f;
                }
                else
                {
                    if (i == 1)
                    {
                        ...
                        DelegateMethods.c_1 = new Color(60, 60, 60, 0) * 0.5f;
                    }
                    else
                    {
                        scale = new Vector2(projectile.scale) * 0.2f;
                        DelegateMethods.c_1 = new Color(80, 80, 80, 0) * 0.5f;
                    }
                }
            ...
            if (projectile.velocity == Vector2.Zero)
            {
                ...
                if (Main.rand.Next(projectile.extraUpdates) == 0)
                {
                    for (int j = 0; j < 2; j = num + 1)
                    {
                        ...
                        int num4 = Dust.NewDust(projectile.Center, 0, 0, 226, vector.X, vector.Y, 0, Color.Black, 1f);
                    ...
                    if (Main.rand.Next(5) == 0)
                    {
                        ...
                        int num5 = Dust.NewDust(projectile.Center + vector2 - Vector2.One * 4f, 8, 8, 31, 0f, 0f, 100, Color.Black, 1.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int index = Dust.NewDust(projectile.oldPos[i], 0, 0, 229, vector2.X, vector2.Y, 0, Color.Black, 1f);
        ...
        {
            return new Color(20, 20, 20, 0) * (1f - projectile.alpha / 255f);
        }
    }
}