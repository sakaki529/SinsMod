...
{
    public class TidalStream : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            rectangle = new Rectangle(0, 90, texture2D.Width, 48);//Head
        ...
        public override void AI()
        {
            ...
            {
                projectile.velocity += 48f * vector;//length
            }
            else
            {
                projectile.Kill();
            ...
            if (projectile.alpha == 0)
            {
                for (int i = 0; i < 2; i++)
                {
                    Dust dust = Main.dust[Dust.NewDust(projectile.position + projectile.velocity * 2f, projectile.width, projectile.height, 172, 0f, 0f, 100, new Color(255, 255, 255, 100), 1.0f)];
                    dust.noGravity = true;
                    dust.velocity *= 2f;
                ...
                while (num4 < num3)
                {
                    if (Main.rand.Next(4) == 0)
                    {
                        ...
                        Dust dust = Main.dust[Dust.NewDust(position, projectile.width, projectile.height, 172, 0f, 0f, 100, new Color(255, 255, 255, 100), 1.2f)];
                        dust.noGravity = true;
                        dust.fadeIn = 0.5f;
                        dust.velocity += projectile.localAI[0].ToRotationVector2();
                        dust.noLight = true;
