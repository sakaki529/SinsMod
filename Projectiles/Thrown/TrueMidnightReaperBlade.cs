...
{
    public class TrueMidnightReaperBlade : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glowTexture = mod.GetTexture("Glow/Projectile/TrueMidnightReaperBlade_Glow");
            ...
            Color GlowColor = SinsColor.TrueMidnightPurple;
            GlowColor.A = 0;
        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[0] == 0)
            {
                ...
                {
                    int d = Dust.NewDust(projectile.position, projectile.width, projectile.height, 21, 0f, 0f, 0, default(Color), 1f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.AddBuff(mod.BuffType("AbyssalFlame"), 30);
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < Main.rand.Next(3, 6); i++)
            {
                int num = Dust.NewDust(projectile.position, projectile.width, projectile.height, 21, 0f, 0f, 0, default(Color), 1f);
