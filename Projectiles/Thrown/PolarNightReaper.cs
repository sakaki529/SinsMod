...
{
    public class PolarNightReaper : ModProjectile
	{
        public override string Texture => "SinsMod/Items/Weapons/MultiType/PolarNightReaper";
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 186, 0f, 0f, 0, default(Color), 1f);
