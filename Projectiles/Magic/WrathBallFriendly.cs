...
{
    public class WrathBallFriendly : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Color color = Color.Lerp(Color.Red, Color.DarkRed, (float)Math.Cos(6.28318548f * (Main.LocalPlayer.miscCounter / 100f)) * 0.5f + 0.5f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 60; i++)
            {
                int num = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 60, 0f, 0f, 100, default(Color), 1.7f);
                Main.dust[num].noGravity = true;
                Main.dust[num].velocity *= 5f;
                num = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 60, 0f, 0f, 100, default(Color), 1f);
                Main.dust[num].noGravity = true;
