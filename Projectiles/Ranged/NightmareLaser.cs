...
namespace SinsMod.Projectiles.Ranged
{
    public class NightmareLaser : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            int num = Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("NigthmareExplosion"), projectile.damage / 2, projectile.knockBack, projectile.owner, 0f, 0f);
