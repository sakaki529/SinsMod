...
{
    public class WhiteNightWaveH : ModProjectile
    {
        public override string Texture => "SinsMod/Projectiles/Melee/WhiteNightWave";
        ...
        {
            return new Color(127, 127, 127, 0) * (1f - projectile.alpha / 255f);
        }
    }
}