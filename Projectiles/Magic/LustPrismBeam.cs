...
{
    public class LustPrismBeam : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Color c_ = new Color(255, 255, 255, 127);//color
        ...
        public override bool PreAI()
        {
            ...
            if (Main.projectile[(int)projectile.ai[1]].active && Main.projectile[(int)projectile.ai[1]].type == mod.ProjectileType("LustPrism"))
            {
            ...
            for (int num826 = 0; num826 < 2; num826++)
            {
                ...
                int num829 = Dust.NewDust(vector72, 0, 0, 242, vector73.X, vector73.Y, 0, default(Color), 1.5f);
            ...
            if (Main.rand.Next(5) == 0)
            {
                ...
                int num830 = Dust.NewDust(vector72 + value40 - Vector2.One * 4f, 8, 8, 112, 0f, 0f, 100, default(Color), 1.2f);
                Main.dust[num830].velocity *= 0.5f;
                Main.dust[num830].velocity.Y = -Math.Abs(Main.dust[num830].velocity.Y);
            }
            DelegateMethods.v3_1 = new Vector3(0.8f, 0.35f, 0.8f);//light
