...
{
    public class PolarNightEnergy : ModProjectile
    {
        public override string Texture => "SinsMod/Extra/Placeholder/BlankTex";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Polar Night Energy");
        }
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                int dust = Dust.NewDust(new Vector2(x, y), 1, 1, 186, 0f, 0f, 0, default(Color), 0.5f);
        ...
        {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("WhiteNightExplosion"), projectile.damage / 2, projectile.knockBack, projectile.owner, 0f, 1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            SinsUtility.Explode(projectile.whoAmI, 120, 120, delegate
            {
                for (int i = 0; i < 40; i++)
                {
                    int num = Dust.NewDust(projectile.position, projectile.width, projectile.height, 186, 0f, -2f, 0, default(Color), 2f);
