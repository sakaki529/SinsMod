...
{
    public class MidnightReaper : ModProjectile
	{
        private bool Spawn;
        private int Count;
        public override string Texture => "SinsMod/Items/Weapons/MultiType/MidnightReaper";
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glowTexture = mod.GetTexture("Glow/Item/MidnightReaper_Glow");
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 27, 0f, 0f, 0, default(Color), 1f);
            ...
            if (Count < 0 && Spawn)
            {
                ...
                {
                    Projectile.NewProjectile(vector, Vector2.Zero, mod.ProjectileType("MidnightReaperBlade"), projectile.damage / 3, 1f, projectile.owner, projectile.ai[0], num6);
                }
