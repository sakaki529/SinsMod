...
{
    public class AbyssalSphere : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] % 30f == 0f && projectile.ai[0] < 180f && Main.netMode != 1)
            {
                ...
                int num4 = 0;
                float num5 = 2000f;
                for (int num6 = 0; num6 < 255; num6 = num + 1)
                {
                    if (Main.player[num6].active && !Main.player[num6].dead)
                    {
                        Vector2 center = Main.player[num6].Center;
                ...
                for (int num8 = 0; num8 < num4; num8 = num + 1)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector95.X, vector95.Y, 580, projectile.damage, 0f, Main.myPlayer, vector.ToRotation(), ai);
                    num = num8;
                }
            }
