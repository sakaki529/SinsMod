...
{
    public class PolarNightRaven : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            player.AddBuff(mod.BuffType("PolarNightRavenMinion"), 3600, true);
            if (player.dead)
            {
                modPlayer.PolarNightRavenMinion = false;
            }
            ...
            if (projectile.ai[0] == 0f)
            {
                ...
                if (!flag)
                {
                    for (int num10 = 0; num10 < 200; num10 = num + 1)
                    {
