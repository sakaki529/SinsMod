...
{
    public class WhiteNightReaperBlade : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glowTexture = mod.GetTexture("Glow/Projectile/WhiteNightReaperBlade_Glow");
            ...
            Color GlowColor = Color.DarkTurquoise;
            GlowColor.A = 0;
        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[0] == 0)
            {
                ...
                {
                    int d = Dust.NewDust(projectile.position, projectile.width, projectile.height, 247, 0f, 0f, 0, default(Color), 1f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < Main.rand.Next(3, 6); i++)
            {
                int num = Dust.NewDust(projectile.position, projectile.width, projectile.height, 247, 0f, 0f, 0, default(Color), 1f);
