...
{
    public class TrueMidnightWaveH : ModProjectile
    {
        public override string Texture => "SinsMod/Projectiles/Melee/TrueMidnightWave";
        ...
        public override void AI()
        {
            for (int i = 0; i < 1; i++)
            {
                ...
                Dust dust = Dust.NewDustDirect(projectile.Center, 0, 0, 112, 0f, 0f, 0, default(Color), 0.6f);
                dust.alpha = 127;
                dust.fadeIn = 0.7f;
                dust.velocity *= 0.3f;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.AddBuff(mod.BuffType("AbyssalFlame"), 180);
            target.AddBuff(BuffID.Bleeding, 180);
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("TrueMidnightSword"), projectile.damage, 0, projectile.owner, target.whoAmI, 0);
        ...
        public override void OnHitPlayer(Player target, int damage, bool crit)
        {
            ...
            target.AddBuff(BuffID.Bleeding, 180);
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("TrueMidnightSword"), projectile.damage, 0, projectile.owner, target.whoAmI, 1);
        }
        ...
        public override void Kill(int timeleft)
		{
            ...
            for (int i = 0; i < num; i++)
            {
                int num2 = Dust.NewDust(projectile.Center, 0, 0, 112, 0f, 0f, 100, default(Color), 0.8f);
