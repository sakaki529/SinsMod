...
{
    public class EternalNightmareArrow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.alpha < 0)
            {
                ...
                while (num2 < num)
                {
                    ...
                    int num3 = Dust.NewDust(projectile.Center, 0, 0, 172, 0f, 0f, 0, default(Color), 1.0f);
            ...
            if (projectile.ai[0] == 1f)
            {
                for (int i = 0; i < 3; i++)
                {
                    ...
                    int num7 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 172, 0f, 0f, 0, default(Color), 1.0f);
                    ...
                    Main.dust[num7].shader = GameShaders.Armor.GetSecondaryShader(44, Main.LocalPlayer);
                }
            }
            ...
            if (projectile.localAI[1] == 15f)
            {
                ...
                for (int i = 0; i < 12; i++)
                {
                    ...
                    int num8 = Dust.NewDust(projectile.Center, 0, 0, 172, 0f, 0f, 160, default(Color), 1.1f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("NigthmareExplosion"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
        }
        ...
        {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("NigthmareExplosion"), projectile.damage / 2, projectile.knockBack, projectile.owner, 0f, 0f);
