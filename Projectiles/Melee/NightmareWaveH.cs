...
{
    public class NightmareWaveH : ModProjectile
    {
        public override string Texture => "SinsMod/Projectiles/Melee/NightmareWave";
        ...
        public override void AI()
        {
            ...
            if (target)
            {
                ...
                projectile.velocity = (6 * projectile.velocity + move) / 5f;
                AdjustMagnitude(ref projectile.velocity);
            }
        }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
            ...
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("NightmareSword"), projectile.damage, 0, projectile.owner, target.whoAmI, 0);
        ...
        public override void OnHitPlayer(Player target, int damage, bool crit)
        {
            ...
            target.AddBuff(BuffID.Bleeding, 300);
            target.AddBuff(BuffID.Ichor, 180);
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("NightmareSword"), projectile.damage, 0, projectile.owner, target.whoAmI, 1);
        }
