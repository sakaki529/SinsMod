...
{
    public class LunarArcanum : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2 = mod.GetTexture("Projectiles/Magic/LunarArcanum2");
            Vector2 origin8 = new Vector2(texture.Width, texture.Height) / 2f;
            ...
            spriteBatch.Draw(texture2, vector53, null, Color.Black, -projectile.rotation + 0.35f, origin8, scale13 * 0.9f, spriteEffects ^ SpriteEffects.FlipHorizontally, 0f);
            spriteBatch.Draw(texture2, vector53, null, color, -projectile.rotation, origin8, projectile.scale * 0.9f, spriteEffects ^ SpriteEffects.FlipHorizontally, 0f);
            spriteBatch.Draw(texture, vector53, null, Color.Black, -projectile.rotation * 0.7f, origin8, projectile.scale * 0.8f, spriteEffects ^ SpriteEffects.FlipHorizontally, 0f);
            spriteBatch.Draw(texture, vector53, null, color, projectile.rotation * 0.5f, origin8, projectile.scale * 0.8f, spriteEffects, 0f);
            return false;
        }
        /*public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D arg_DA77_1 = mod.GetTexture("Projectiles/Magic/LunarArcanum2");
            ...
            Texture2D arg_DAC3_1 = mod.GetTexture("Projectiles/Magic/LunarArcanum2");
            ...
            Texture2D arg_DB72_1 = mod.GetTexture("Projectiles/Magic/LunarArcanum2");
            ...
            arg_DB72_0.Draw(arg_DB72_1, arg_DB72_2, sourceRectangle2, alpha4 * 0.8f, projectile.rotation, origin8, projectile.scale * 0.9f, spriteEffects, 0f);
            alpha4.A = 0;
            return false;
        }*/
        public override void AI()
        {
            ...
            if (num1013 == 0)
            {
                ...
                if (Main.rand.Next(3) == 0)
                {
                    ...
                    else
                    {
                        ...
                        Dust dust29 = Main.dust[Dust.NewDust(projectile.Center - vector141 * 30f, 0, 0, 206, 0f, 0f, 0, default(Color), 1f)];
            ...
            else if (num1013 == 1)
            {
                ...
                for (int num1014 = 0; num1014 < 1; num1014 = num3 + 1)
                {
                    if (Main.rand.Next(2) == 0)
                    {
                        ...
                        Dust dust30 = Main.dust[Dust.NewDust(projectile.Center - vector142 * 30f, 0, 0, 135, 0f, 0f, 0, default(Color), 1f)];
                        ...
                        dust30 = Main.dust[Dust.NewDust(projectile.Center - vector142 * 30f, 0, 0, 229, 0f, 0f, 0, default(Color), 0.5f)];
                        dust30.noGravity = true;
                        dust30.position = projectile.Center - vector142 * Main.rand.Next(10, 21);
                        dust30.velocity = vector142.RotatedBy(1.5707963705062866, default(Vector2)) * 6f;
                        dust30.scale = 0.9f + Main.rand.NextFloat();
                    ...
                    else
                    {
                        ...
                        Dust dust31 = Main.dust[Dust.NewDust(projectile.Center - vector143 * 30f, 0, 0, 206, 0f, 0f, 0, default(Color), 1f)];
                ...
                if (projectile.ai[0] % 30f == 0f && projectile.ai[0] < 241f && Main.myPlayer == projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector144.X, vector144.Y, mod.ProjectileType("LunarArcanum2"), projectile.damage / 2, 0f, projectile.owner, 0f, (float)projectile.whoAmI);
                }
            ...
            if (projectile.alpha < 150)
            {
                ...
                Lighting.AddLight(projectile.Center, 0.2f, 0.7f, 0.6f);
            }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num96 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 206, 0f, 0f, 100, default(Color), 1.5f);
            ...
            {
                int num98 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 229, 0f, 0f, 200, default(Color), 1.7f);//3.7
                ...
                dust.velocity *= 3f;
                num98 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 206, 0f, 0f, 100, default(Color), 1.7f);//1.5
                Main.dust[num98].position = projectile.Center + Vector2.UnitY.RotatedByRandom(3.1415927410125732) * (float)Main.rand.NextDouble() * projectile.width / 2f;
            ...
            {
                int num100 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 229, 0f, 0f, 0, default(Color), 1.2f);//2.7
                Main.dust[num100].position = projectile.Center + Vector2.UnitX.RotatedByRandom(3.1415927410125732).RotatedBy(projectile.velocity.ToRotation(), default(Vector2)) * (float)projectile.width / 2f;
            ...
            {
                int num102 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 206, 0f, 0f, 0, default(Color), 1.5f);
                Main.dust[num102].position = projectile.Center + Vector2.UnitX.RotatedByRandom(3.1415927410125732).RotatedBy(projectile.velocity.ToRotation(), default(Vector2)) * (float)projectile.width / 2f;
            ...
            if (Main.myPlayer == projectile.owner)
            {
                ...
                {
                    if (Main.projectile[num105].active && Main.projectile[num105].type == mod.ProjectileType("LunarArcanum2") && Main.projectile[num105].ai[1] == projectile.whoAmI)
                    {
                ...
                for (int num110 = 0; num110 < num106; num110 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(vector4.X, vector4.Y, vector5.X, vector5.Y, mod.ProjectileType("LunarArcanumShard"), (int)(projectile.damage * 0.65), projectile.knockBack * 0.8f, projectile.owner, num108, 0f);
                    num3 = num110;
                }
                for (int num111 = 0; num111 < num107; num111 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(vector6.X, vector6.Y, vector7.X, vector7.Y, mod.ProjectileType("LunarArcanumShard"), (int)(projectile.damage * 0.65), projectile.knockBack * 0.8f, projectile.owner, num109, 0f);
                    num3 = num111;
                }
            }
        }
