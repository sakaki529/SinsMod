...
{
	public class NightfallStaff : ModItem
	{
        public override string Texture => "SinsMod/Extra/Placeholder/Placeholder";
        public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("Rose at Nightfall");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            item.shoot = (player.altFunctionUse != 2) ? mod.ProjectileType("Thorn") : mod.ProjectileType("NightfallBeam");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "WhiteNightStaff");
