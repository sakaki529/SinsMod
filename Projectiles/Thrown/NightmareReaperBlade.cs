...
{
    public class NightmareReaperBlade : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glowTexture = mod.GetTexture("Glow/Projectile/NightmareReaperBlade_Glow");
            ...
            Color GlowColor = SinsColor.NightmareRed;
            //Color GlowColor = Color.Lerp(Color.HotPink, Color.Crimson, (float)Math.Cos(6.28318548f * (Main.LocalPlayer.miscCounter / 100f)) * 0.5f + 0.5f);
            GlowColor.A = 0;
        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[0] == 0)
            {
                ...
                {
                    int d = Dust.NewDust(projectile.position, projectile.width, projectile.height, 182, 0f, 0f, 0, default(Color), 1f);
                    Main.dust[d].noGravity = true;
                    Main.dust[d].velocity *= 3f;
                    Main.dust[d].scale = 0.5f + Utils.NextFloat(Main.rand, 0.3f);
                }
        ...
        public override void Kill(int timeLeft)
        {
            for (int i = 0; i < Main.rand.Next(3, 6); i++)
            {
                int num = Dust.NewDust(projectile.position, projectile.width, projectile.height, 182, 0f, 0f, 0, default(Color), 1f);
                Main.dust[num].noGravity = true;
                Main.dust[num].velocity *= 3f;
                Main.dust[num].scale = 0.5f + Utils.NextFloat(Main.rand, 0.3f);
            }
        }
    }
}