...
{
    public class LightOfEdenLaser : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Color color = Main.hslToRgb(1.25f, 1.0f, 0.4f);
            color.A = 0;
        ...
        public override void AI()
        {
            ...
            if (!proj.active || proj.type != mod.ProjectileType("LightOfEden"))
            {
                projectile.Kill();
            }
            ...
            if (proj.ai[0] >= 180f)
            {
                projectile.damage = (int)((double)projectile.damage * 2.8f);
            ...
            if (Math.Abs(projectile.localAI[1] - num9) < 100f && projectile.scale > 0.15f)
            {
                ...
                Color color = new Color(255, 255, Main.DiscoB + 125); //light color
                color.A = 0;
                ...
                for (int num11 = 0; num11 < 2; num11++)
                {
                    ...
                    int d = Dust.NewDust(vector2, 0, 0, 87, vector3.X, vector3.Y, 0, default(Color), 1f);
