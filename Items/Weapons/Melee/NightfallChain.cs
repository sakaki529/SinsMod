...
namespace SinsMod.Items.Weapons.Melee
{
    public class NightfallChain : ModItem
	{
		...
		public override void SetDefaults()
		{
            ...
            item.knockBack = 0.5f;
            item.shootSpeed = 24f;
            item.shoot = mod.ProjectileType("NightfallChain");
            item.rare = 10;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "WhiteNightChain");
