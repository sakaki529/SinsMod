...
{
	public class TrueMidnightStaff : ModItem
	{
        public override string Texture => "SinsMod/Extra/Placeholder/Placeholder";
        public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("True Rose at Midnight");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            item.shoot = (player.altFunctionUse != 2) ? mod.ProjectileType("Thorn") : mod.ProjectileType("TrueMidnightBeam");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "MidnightStaff");
