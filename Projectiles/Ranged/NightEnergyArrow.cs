...
{
    public class NightEnergyArrow : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Night Energy Arrow");
        }
        ...
        public override void AI()
        {
            ...
            if (flag)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    int num2 = Dust.NewDust(projectile.Center, 0, 0, 186, 0f, 0f, 100, default(Color), 0.8f);
