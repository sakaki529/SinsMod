...
{
    public class RitualGluttony : ModNPC
    {
        ...
        {
            Color color = SinsColor.Gluttony;
            color.A = 0;
            return color;
        }
        public override void AI()
        {
            ...
            if (npc.ai[1] == 180f && !NPC.AnyNPCs(mod.NPCType("Gluttony")))
            {
                NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y + 60, mod.NPCType("Gluttony"));
            }
            ...
            if (npc.alpha == 0)
            {
                ...
                for (int num2 = 0; num2 < 2; num2 = num1 + 1)
                {
                    ...
                    vector2.Normalize();
                    int num5 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height, 55, 0f, 0f, 100, default(Color), 1.5f);
            ...
            if (npc.ai[1] >= 60f)
            {
                ...
                for (int num2 = 0; num2 < 1; num2 = num1 + 1)
                {
                    ...
                    Vector2 vector2 = new Vector2(Main.rand.Next(-10, 11), Main.rand.Next(-10, 11));
                    vector2.Normalize();
                    int num3 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height, 55, 0f, 0f, 100, default(Color), 1.5f);
