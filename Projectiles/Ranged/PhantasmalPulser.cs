...
{
    public class PhantasmalPulser : ModProjectile
	{
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glow = mod.GetTexture("Glow/Projectile/PhantasmalPulser_Glow");
            ...
            Main.spriteBatch.Draw(glow, projectile.Center - Main.screenPosition + new Vector2(0f, projectile.gfxOffY), new Rectangle?(new Rectangle(0, num2, texture.Width, num)), projectile.GetAlpha(Color.White), projectile.rotation, new Vector2(texture.Width / 2f, num / 2f), projectile.scale, SpriteEffects.None, 0f);
            return false;
        }
        public override void AI()
        {
            ...
            if (projectile.type == mod.ProjectileType("PhantasmalPulser"))
            {
                projectile.ai[0] += 1f;
                int num2 = 0;
                ...
                if (projectile.soundDelay <= 0)
                {
                    ...
                    {
                        Main.PlaySound(2, (int)projectile.position.X, (int)projectile.position.Y, 114);//5
                    }
                }
                if (flag && Main.myPlayer == projectile.owner)
                {
                    ...
                    if (flag2)
                    {
                        ...
                        int num6 = mod.ProjectileType("PhantasmalPulse");
