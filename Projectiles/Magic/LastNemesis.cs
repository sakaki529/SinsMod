...
{
    public class LastNemesis : ModProjectile
	{
        public override string Texture => "SinsMod/Items/Weapons/Magic/LastNemesis";
            ...
            if (flag2 && Main.myPlayer == projectile.owner)
            {
                ...
                if (flag4)
                {
                    if (projectile.ai[0] == 1f)
                    {
                        ...
                        for (int l = 0; l < 6; l++)
                        {
                            Projectile.NewProjectile(center.X, center.Y, vector2_.X, vector2_.Y, mod.ProjectileType("LastNemesisLaser"), num5, projectile.knockBack, projectile.owner, l, projectile.whoAmI);
                        }
                        projectile.netUpdate = true;
                    }
                }
