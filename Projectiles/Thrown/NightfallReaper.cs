...
{
    public class NightfallReaper : ModProjectile
	{
        private bool Spawn;
        private int Count;
        public override string Texture => "SinsMod/Items/Weapons/MultiType/NightfallReaper";
        public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("Nightfall Reaper");
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glowTexture = mod.GetTexture("Glow/Item/NightfallReaper_Glow");
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 174, 0f, 0f, 0, default(Color), 1f);
            ...
            if (Count < 0 && Spawn)
            {
                ...
                {
                    Projectile.NewProjectile(vector, Vector2.Zero, mod.ProjectileType("NightfallReaperBlade"), projectile.damage / 3, 1f, projectile.owner, projectile.ai[0], num6);
                }
                Count = Main.rand.Next(18, 26);
            }
