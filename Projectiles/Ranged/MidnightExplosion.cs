...
{
    public class MidnightExplosion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                num *= num4;
                num2 *= num4;
                int NewDust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 181, 0f, 0f, 100, default(Color), 1.0f);
