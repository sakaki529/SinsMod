...
{
    public class MidnightEnergy : ModProjectile
    {
        public override string Texture => "SinsMod/Extra/Placeholder/BlankTex";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Midnight Energy");
        }
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                int dust = Dust.NewDust(new Vector2(x, y), 1, 1, 181, 0f, 0f, 0, default(Color), 0.5f);
        ...
        {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("MidnightExplosion"), projectile.damage / 2, projectile.knockBack, projectile.owner, 0f, 1f);
