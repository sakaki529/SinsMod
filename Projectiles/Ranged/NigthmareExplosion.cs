...
{
    public class NigthmareExplosion : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            projectile.localNPCHitCooldown = 3;//Laser
        }
        public override void AI()
        {
            if (projectile.ai[1] == 1f)//Energy
            {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                num *= num4;
                num2 *= num4;
                int NewDust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 182, 0f, 0f, 100, default(Color), 1.0f);
