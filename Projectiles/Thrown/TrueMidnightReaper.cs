...
{
    public class TrueMidnightReaper : ModProjectile
	{
        private bool Spawn;
        private int Count;
        public override string Texture => "SinsMod/Items/Weapons/MultiType/TrueMidnightReaper";
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D glowTexture = mod.GetTexture("Glow/Item/TrueMidnightReaper_Glow");
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 21, 0f, 0f, 0, default(Color), 1f);
            ...
            if (Count < 0 && Spawn)
            {
                ...
                {
                    Projectile.NewProjectile(vector, Vector2.Zero, mod.ProjectileType("TrueMidnightReaperBlade"), projectile.damage / 3, 1f, projectile.owner, projectile.ai[0], num6);
                }
                Count = Main.rand.Next(12, 20);
            }
