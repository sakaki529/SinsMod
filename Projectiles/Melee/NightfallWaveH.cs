...
{
    public class NightfallWaveH : ModProjectile
    {
        public override string Texture => "SinsMod/Projectiles/Melee/NightfallWave";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Nightfall Wave");
        ...
        public override void AI()
        {
            for (int i = 0; i < 1; i++)
            {
                ...
                Dust dust = Dust.NewDustDirect(projectile.Center, 0, 0, 174, 0f, 0f, 0, default(Color), 0.6f);
                dust.alpha = 127;
                dust.fadeIn = 0.7f;
                dust.velocity *= 0.3f;
        ...
        public override void Kill(int timeleft)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                int num2 = Dust.NewDust(projectile.Center, 0, 0, 174, 0f, 0f, 100, default(Color), 0.8f);
