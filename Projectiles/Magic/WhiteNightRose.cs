...
{
    public class WhiteNightRose : ModProjectile
    {
                ...
                for (float num4 = 0f; num4 < num; num4++)
                {
                    for (int num5 = 0; num5 < 2; num5++)
                    {
                        ...
                        for (float num6 = 0f; num6 < num3; num6++)
                        {
                            ...
                            int num7 = Dust.NewDust(projectile.Center, 6, 6, 247, 0f, 0f, 100, default, 1.3f);
                ...
                for (float num8 = 0f; num8 < num; num8++)
                {
                    for (int num9 = 0; num9 < 2; num9++)
                    {
                        ...
                        for (float num10 = 0f; num10 < num3; num10++)
                        {
                            ...
                            int num11 = Dust.NewDust(projectile.Center, 6, 6, 247, 0f, 0f, 100, default, 1.3f);
